...
The ladder this decision shipped, on 2026-08-06, was T1 `zai-coding-plan/glm-5-turbo`,
...
the D-154 outage would have made the corrected tiers file look like the drift, and
"fixing" it back resurrects the provider-500. What survives here is the ARGUMENT for one
vendor per tier; the roster belongs to the file that is maintained as a roster.
